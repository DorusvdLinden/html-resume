# html-resume
A single-page résumé template done purely with HTML and CSS, which can be rendered into PDF through web browsers' print-to-PDF functionality, making a nice, sleek, professsional and ready-to-print résumé. See a living example at: https://mnjul.net/cv/resume.pdf
...
# Updates
* Updated with increased font size & adapted spacing
* Update to new Font Awesome version: https://github.com/FortAwesome/Font-Awesome
* Added links: https://github.com/necolas/normalize.css/
...
* Icons from [Font Awesome](https://github.com/FortAwesome/Font-Awesome) are used and are incorporated as a git submodule in this repository.
* [Normalize.css](https://github.com/necolas/normalize.css/) is used and is incorporated as a git submodule in this repository.
